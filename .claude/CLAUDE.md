...
Maison Héritage — Digital Flagship

A luxurious, mobile‑first bilingual website that authentically expresses the brand’s French heritage, showcases a scalable, SEO‑optimized wine catalog with authoritative tasting content, and reliably converts interest into tasting bookings, trade inquiries and collector leads. Built for speed, accessibility and easy editorial/translation workflows, it becomes the brand’s premium digital storefront for tourism and international trade.

- Global & UX
  - Sitewide language switcher (FR/EN) with localized URLs (/fr/, /en/) and clean hreflang. Mobile‑first responsive templates, accessible navigation, consistent breadcrumbs, sticky top CTA for “Book a Tasting / Contact.”
- Homepage & Brand
  - Full‑bleed hero with subtle motion, heritage storytelling pages, quick links to catalog, experiences and contact; minimalist, luxury visual system and typography.
- Wine catalog & SEO
  - Scalable catalog: collection index by variety (Red/White/Rosé/Sparkling) + region pages. Filters: variety, region/appellation, vintage range, price, cellar potential, tasting‑note keywords. Pagination for SEO. Structured data/schema for wines and events.
- Wine detail template (mandatory fields)
  - High‑res hero + gallery, short & long tasting notes, region/appellation, appellation map tag, varietal, vintage, ABV, optional pH, aging/cellar potential, production notes, food pairings, bottle sizes, SKU/ID, clear CTAs: Book / Inquire / Trade.
